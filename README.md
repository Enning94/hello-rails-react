...
- Fetch random data from database through API-endpoint
...
```sh
  git clone git@github.com:Enning94/hello-rails-react.git
```
...
Feel free to check the [issues page](https://github.com/Enning94/hello-rails-react/issues).
